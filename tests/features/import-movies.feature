Feature: Import Movies
  ...
  Scenario: Import movies from TMDB and Watchmode data
    Given stub Watchmode data is loaded from "tests/test-double-data/watchmode/import/title_id_map.csv"
    And stub TMDB data is loaded from "tests/test-double-data/tmdb/import/movie_ids.json"
